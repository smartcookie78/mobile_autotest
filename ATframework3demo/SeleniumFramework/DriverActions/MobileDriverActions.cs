...
namespace atFrameWork2.SeleniumFramework
{
    public class MobileDriverActions : BaseDriverActions
    {
        ...
        public static AppiumDriver GetNewMobileDriver()
        {
            ...
            appiumOptions.App = "C:/Users/user/Downloads/bitrix24_university.apk"; // Путь к приложению
            appiumOptions.AddAdditionalAppiumOption(MobileCapabilityType.Udid, "3f03a951");//"emulator-5554"/); // Уникальный идентификатор устройства
